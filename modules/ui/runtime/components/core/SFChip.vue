<template>
  <div class="group relative">
    ...
    />
    <div
      class="flex h-10 items-center justify-center rounded-lg px-4 text-sm font-semibold text-secondary outline outline-2 outline-gray-500 group-hover:outline-2 group-hover:outline-accent peer-checked:bg-accent peer-checked:text-white peer-checked:outline-accent"
    >
      <slot />
    </div>
  </div>
