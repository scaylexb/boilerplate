<template>
  <SFRecentlyViewedProductsSlider
    v-live-preview:padding="contentElement"
    class="w-full"
...
import type { RecentlyviewedproductsComponent } from '../types/gen/contentstack'
...
const { contentElement } = defineProps<{
  contentElement: RecentlyviewedproductsComponent
}>()
