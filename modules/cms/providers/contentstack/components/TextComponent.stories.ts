...
import type { TextComponent as TextComponentType } from '../types/gen/contentstack'
import Text from './TextComponent.vue'

/**
 * Contentstack Text component displays text content with configurable HTML elements and styling.
 ...
 * - Contentstack field-based data structure (content, text_type)
