...
import type { ImageComponent as ImageComponentType } from '../types/gen'
import Image from './ImageComponent.vue'

/**
 * The Amplience Image component displays responsive images with support for different
...
const meta = {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component:
          'A responsive image component that displays Amplience assets with configurable aspect ratios for desktop and mobile viewports.',
      },
    },
  },
}
