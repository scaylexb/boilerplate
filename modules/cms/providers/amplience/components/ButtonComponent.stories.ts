...
import type { ButtonComponent as ButtonComponentType } from '../types/gen'
import Button from './ButtonComponent.vue'

/**
 * Amplience Button component renders interactive button elements from Amplience CMS data.
 ...
 * - URL navigation
 * - Amplience field-based data structure (text, style, url)
