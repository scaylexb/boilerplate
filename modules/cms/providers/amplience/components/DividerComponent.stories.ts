...
import type { DividerComponent as DividerComponentType } from '../types/gen'
import DividerComponent from './DividerComponent.vue'

/**
 * The Amplience Divider component provides visual and spacing separation between content sections.
 * It supports different height options for spacing and can optionally display a horizontal line.
 * This component is designed to work with Amplience CMS content structure.
 */
