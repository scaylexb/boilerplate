...
/**
 * Amplience AccordionItem component renders a single collapsible accordion entry with a title and content.
 * Uses SFAccordionEntry to provide expandable/collapsible behavior.
 *
 * Key features:
 * - Collapsible/expandable behavior via SFAccordionEntry
 * - Dynamic title from Amplience fields
...
const meta = {
  title: 'CMS Amplience/AccordionItem',
